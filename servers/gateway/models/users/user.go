...
func (nu *NewUser) ToUser() (*User, error) {
	...
	// fmt.Println(newUserStruct.Email)

	// fmt.Println(newUserStruct)

	// h := md5.New()
	// io.WriteString(h, strings.ToLower(strings.TrimSpace(newUserStruct.Email)))
	// newUserStruct.PhotoURL = fmt.Sprintf("%s%s", gravatarBasePhotoURL, fmt.Sprintf("%x", h.Sum(nil)))
	...
	// fmt.Println(newUserStruct.PhotoURL)
